export const site = {
  ...
  resume: "/resume.pdf",
  socials: {
    github: "https://github.com/AviralKhanna",
  ...
  achievements: [
    "Drafted 2 patents for DASES (Descriptive Answer Sheet Evaluation System) under university innovation initiatives.",
    "Awarded the SHODH Grant (₹49,000) to build LexiBot, an AI-powered legal assistant (2025–26).",
    "1st place in the DevOps Bootcamp by INT Israel, against 200+ participants.",
    "Shortlisted for the Smart India Hackathon two years running (2024 & 2025).",
  ],
};
